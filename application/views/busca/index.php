                ...
                foreach ($busca as $key) { ?>
                    ...
                    <div class="vendor-thumbnail">
                        ...
                        <div class="vendor-img zoomimg">
                            <!-- Vendor img -->
                            <a href="<?php echo base_url() ?>busca/detalhes/<?php echo $key->id ?>"><img src="<?php echo base_url() ?>public/img/decoracao/<?php echo $key->foto_perfil ?>" alt="" class="img-fluid"></a>
                            <div class="wishlist-sign"><a href="#" class="btn-wishlist"><i class="fa fa-heart"></i></a></div>
                        </div>
                        <!-- /.Vendor img -->
                        <div class="vendor-content">
                            <!-- Vendor Content -->
                            <h2 class="vendor-title"><a href="#" class="title"><?php echo $key->nome ?></a></h2>
                            <p class="vendor-address">Categoria</p>
                        </div>
                        <div class="vendor-meta">
                            <div class="vendor-meta-item vendor-meta-item-bordered">
                                <span class="vendor-price">
                                    $<?php echo $key->valor_100 ?>
                                </span>
                                <span class="vendor-text">100 Pessoas</span></div>
                            <div class="vendor-meta-item vendor-meta-item-bordered">
